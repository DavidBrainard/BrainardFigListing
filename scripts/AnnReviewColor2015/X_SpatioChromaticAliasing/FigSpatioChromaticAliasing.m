...
imwrite(coneMosaicImageTrichrom, ['ConeMosaicTrichrom'  '.' figParams.imType],figParams.imType);
imwrite(coneMosaicImageDichrom, ['ConeMosaicDichrom'  '.' figParams.imType],figParams.imType);
...
imwrite(photonsTrichromImageRawSpd/tempScaleFactor, ['ConePhotonMapTrichromSpd'  '.' figParams.imType],figParams.imType);
imwrite(photonsTrichromImageRawMetamer/tempScaleFactor, ['ConePhotonMapTrichromMetamer'  '.' figParams.imType],figParams.imType);
imwrite(photonsDichromImageRawSpd/tempScaleFactor, ['ConePhotonMapDichromSpd'  '.' figParams.imType],figParams.imType);
imwrite(photonsDichromImageRawMetamer/tempScaleFactor, ['ConePhotonMapDichromMetamer'  '.' figParams.imType],figParams.imType);
